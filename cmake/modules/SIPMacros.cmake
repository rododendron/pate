...
MACRO(ADD_SIP_PYTHON_MODULE MODULE_NAME MODULE_SIP)
    ...
    ENDIF(NOT WIN32)
    message(STATUS "${SIP_EXECUTABLE} ${_sip_tags} ${_sip_x} ${SIP_EXTRA_OPTIONS} -j ${SIP_CONCAT_PARTS} -c ${CMAKE_CURRENT_BINARY_DIR}/${_module_path} ${_sip_includes} ${_abs_module_sip}")
    ADD_CUSTOM_COMMAND(
